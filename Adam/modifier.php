...
foreach($listeProduit as $produit){
	...
	<tr>
        ...
        <td>
							   <button type="" value="" class="btn-actions" ><a href="modif.php?id=<?php echo $produit['id']; ?>" class="active" ui-toggle-class=""><i class="fa fa-check text-success text-active"></i></a></button>
