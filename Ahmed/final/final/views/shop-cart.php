                ...
                ?>
                  <tr>
                    ...
                    <td class="product-name">
                      <h2 class="h5 text-black"><?php echo $p['nom_pro']; ?></h2>
                    </td>
                    ...
                    <td>
                      <div class="input-group mb-3" style="max-width: 150px;">
                        ...
                        <div class="input-group-append">
                        	 <button class="number-button minus" type="button">&minus;</button>
                          <button class="number-button plus" type="button">&plus;</button>
                        </div>
                      </div>
