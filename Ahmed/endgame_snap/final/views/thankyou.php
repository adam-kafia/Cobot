...
<html lang="en">
	...
	<body class="preload">
		...
		<main>
			<!-- PAGE INFO -->
			<section class="page-info set-bg" data-bg="images/page-info-bg-2.jpg">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Votre commande a été aboutie avec succes !</p>
            <p><a href="index.html" class="btn btn-sm btn-primary">Retour a l'acceuil.</a></p>
            <br><br>
          </div>
        </div>
      </div>
