                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu"><li>
                            ...
                            <li><i class="fa fa-id-card-o"></i><a href="afficher.php">View catalogues</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                ...
                <a class="navbar-brand" href="./"><img style="width:19%;" src="images/logo.png" alt="Logo"></a>
...
foreach($listeProduit as $produit){
	...
	<tr>
        ...
        <td style ='text-align:center;'><?php echo "<img src = 'samples/".$produit['image'].".jpg' style='width:100px;'>";?><br><?php echo $produit['image'] ?></td>
        <td><?PHP echo $produit['categorie_id']; ?></td>
        <td>
							   <button type="" value="" class="btn-actions" ><a href="modifierProd.php?id=<?php echo $produit['id'];?>" class="active" ui-toggle-class=""><i class="fa fa-check-square"></i></a></button>
